...
public class HandTest {
    ...
    public void testGetNumberOfCards() {
        Deck deck = new Deck();
        Hand hand = new Hand(Arrays.asList(deck.pick(5)));
    ...
    public void testInvalidHandRank() {
        ...
        assertEquals("Can not rank a hand with 2 cards(s).", handTwo.describeHandRank());
        ...
        assertEquals("Can not rank a hand with 6 cards(s).", handSix.describeHandRank());
    ...
    public void testBestHand() {
        ...
        BestHand bestHand = new BestHand(cards);
        assertEquals("Two pair, nines and twos", bestHand.singleBestHand());
    }

    @Test
    public void testBestHandTenCards() {
        ArrayList<Card> cards = new ArrayList<Card>();
        cards.add(new Card(CardRank.NINE, Suit.CLUBS));
        cards.add(new Card(CardRank.NINE, Suit.HEARTS));
        cards.add(new Card(CardRank.TEN, Suit.DIAMONDS));
        ...
        cards.add(new Card(CardRank.TEN, Suit.CLUBS));
        BestHand bestHand = new BestHand(cards);
        assertEquals("Flush, queen high", bestHand.singleBestHand());
    }
}
